...
def detect_arch():
    ...
    if host_machine in architectures:
        return host_machine
    elif host_machine in architectures_aliases.keys():
        return architectures_aliases[host_machine]
    elif "86" in host_machine: # Catches i386, i486, i586, i686, etc.
        return "x86_32"
    else:
        print("Unsupported CPU architecture: %s" % host_machine)
