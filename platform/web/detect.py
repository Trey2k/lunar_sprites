...
def configure(env: "Environment"):
    ...
    # Wrap the JavaScript support code around a closure named LunarSprites.
    env.Append(LINKFLAGS=["-s", "MODULARIZE=1", "-s", "EXPORT_NAME='LunarSprites'"])
    ...
    env.Append(LINKFLAGS=["-s", "EXPORTED_RUNTIME_METHODS=['callMain']"])
